export default {
  ...
  confirm: { zh: '确认', 'zh-TW': '確認', en: 'Confirm', ja: '確認', ko: '확인' },
  reset: { zh: '重置', 'zh-TW': '重置', en: 'Reset', ja: 'リセット', ko: '초기화' },
  ...
  actionReorganize: { zh: '重整', 'zh-TW': '重整', en: 'Reorganize', ja: '再編成', ko: '재편성' },
  actionRun: { zh: '逃跑', 'zh-TW': '逃跑', en: 'Run', ja: '逃げる', ko: '도망' },
  actionBloom: { zh: '怒放', 'zh-TW': '怒放', en: 'Bloom', ja: '開花', ko: '개화' },
  reorganize: { zh: '{name} 进行技能重整，消耗一回合', 'zh-TW': '{name} 進行技能重整，消耗一回合', en: '{name} reorganizes skills, consuming a turn', ja: '{name}は再編成を行い、1ターンを消費した', ko: '{name} 재편성을 수행하며 한 턴을 소모합니다' },
