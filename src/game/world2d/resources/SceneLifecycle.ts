...
export class SceneLifecycle {
     ...
     */
    static async prepareScene(mapData: any, engine: GameEngine, entryId: string = 'default', savedState: any = null, onProgress: any = null) {
    ...
    static destroyScene(scene: any, engine: GameEngine) {
