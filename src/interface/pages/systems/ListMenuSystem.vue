...
import InventoryPanel from '@/interface/panels/InventoryPanel.vue';
import CharacterPanel from '@/interface/panels/CharacterPanel.vue';
import EquipmentPanel from '@/interface/panels/EquipmentPanel.vue';
import SkillsPanel from '@/interface/panels/SkillsPanel.vue';
import ThankPanel from '@/interface/panels/ThankPanel.vue';
import SystemPanel from '@/interface/panels/SystemPanel.vue';
import SaveLoadPanel from '@/interface/panels/SaveLoadPanel.vue';
import FormationPanel from '@/interface/panels/FormationPanel.vue';
...
<style scoped src="@styles/pages/systems/ListMenuSystem.css"></style>
